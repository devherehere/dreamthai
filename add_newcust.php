...
//	$run =  sprintf ("%03d", $rec_run[0]); 
    ...
    if (@$_GET['id_key'] == md5('add')) {
     ...
     VALUES
           ...
           ,NULL
           ," . trim($_POST['type_id']) . "
           ," . trim($_POST['credit_cust']) . "
           ,1
           ,NULL
           ,'" . trim($_POST['curcen_id']) . "'
           ,1
           ,'" . $_SESSION["user_id"] . "'
           ,'" . date("Y/m/d H:i:s") . "'
           ,NULL
     ...
     VALUES
           ('" . trim($_POST['id_arf']) . "'
           ,'01'
           ,'" . trim($_POST['add_no_cust']) . "'
           ,'" . trim($_POST['province_cust']) . "'
           ,'" . trim($_POST['ampur_cust']) . "'
           ,'" . trim($_POST['tumbon_cust']) . "'
           ,'" . trim($_POST['phone_cust']) . "'
           ,'" . trim($_POST['fax_cust']) . "'
           ,'" . trim($_POST['mobile_cust']) . "'
           ,'" . trim($_POST['url_cust']) . "'
           ,'" . trim($_POST['email_cust']) . "'
           ,NULL
           ,1
           ,1
           ,'" . $_SESSION["user_id"] . "'
     ...
     VALUES
           ('" . trim($_POST['id_arf']) . "'
           ,'01'
           ,'" . trim($_POST['title_contact_cust']) . "'
           ,'" . trim($_POST['n_contact_cust']) . "'
           ,'" . trim($_POST['l_contact_cust']) . "'
           ,'" . trim($_POST['tell_contact_cust']) . "'
           ,'" . trim($_POST['email_contact']) . "'
           ,'" . trim($_POST['depart_cust']) . "'
           ,NULL
           ,1
           ,1
           ,'" . $_SESSION["user_id"] . "');";
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top" align="right"> วงเงินเครดิต(บาท)
                        <input type="text" name="credit_cust" size="22"
                               class="validate[required,length[0,13],custom[onlyNumber]]">
                        <BR>
                        ประเภทภาษีของกิจการ
        ...
        <fieldset style="width:96%; margin-left:11px; margin-bottom:10px;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td align="left">เบอร์โทรศัพท์
                        <input type="text" name="tell_contact_cust" size="30" class="validate[required,length[0,50]]">
                    </td>
                    <td align="left">E-mail
                        <input type="text" name="email_contact" size="50"
                               class="validate[required,custom[email],length[0,50]]"></td>
                </tr>
            </table>
        </fieldset>
