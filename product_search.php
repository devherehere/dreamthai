            ...
            <div class="mian">
                ...
                <div class="content">
                    ...
                    if ($_SESSION["user_ses"] != '' && $_SESSION["user_id"] != '') {
                        ...
                        $add = md5('Insert');
                        ?>
                        <form method="post" name="01"
                              action="product_search.php?bo=<?= $_GET['bo']; ?>&id=<?= $add; ?>&clam=<?= $_GET['clam']; ?>">
                                    ...
                                    <tr>
                                        <td align="left"> หมวดสินค้า
                                            <select name="pro_g" class="frominput">
                                                ...
                                                ?>
                                                <option value="all" selected="selected" id="selected">
                                                    ------------ทั้งหมด------------
                                                </option>
                                            </select>
                                            ยี่ห้อ
                                        ...
                                        <td rowspan="2" align="left" width="150"><input type="submit" class="search_but" value="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> รหัสสินค้า <input type="text" name="pro_id" size="30">
                                                ชื่อสินค้า <input type="text" name="pro_name" size="70"></td>
                                                    ...
                                                    <?php
                                                    if ($_GET['bo'] == 'true'):
                                                        $action = 'process_rent.php?id_s=' . $add_temp;

                                                    elseif ($_GET['clam'] == 'true'):
                                                        $action = 'process_cn.php';

                                                    endif;
                                                    ?>
                                                    <form method="post" action="<?= $action; ?>" name="02">
                                                        <fieldset style="width:96%; margin-left:11px; margin-bottom:10px;">
                                                            ...
                                                            if ($_GET['id'] == ''):
                                                                ?>
                                                                <div style="text-align: center;color: red">ไม่ได้เลือกสินค้า!</div>
                                                                <?php
                                                            else:
                                                                ?>
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="1" cellpadding="0" style="color:#FFF;">
                                                                                <tr bgcolor="#333333" height="30">
                                                                                    ...
                                                                                    if ($_GET['bo'] == 'true' || $_GET['clam'] == 'true'):
                                                                                        ?>
...
WHERE        (Goods_Price_List.GPL_STATUS = 1)";
                                                                                    ...
                                                                                    while ($dbgseh = sqlsrv_fetch_array($seach)) {
                                                                                        ...
                                                                                        <tr bgcolor="#CCCCCC" height="30">
                                                                                            ...
                                                                                            <td align="left" bgcolor="#888888">
                                                                                                &nbsp;<?= $dbgseh['GOODS_CODE'] ?></td>
                                                                                            <td align="left" bgcolor="#888888">
                                                                                                &nbsp;<?= $dbgseh['GOODS_NAME_MAIN'] ?></td>
                                                                                            <td align="left" bgcolor="#888888">
                                                                                                &nbsp;<?= $dbgseh['CATE_NAME'] ?></td>
                                                                                            <td align="left" bgcolor="#888888">
                                                                                                &nbsp;<?= $dbgseh['BRAND_NAME'] ?></td>
                                                                                            <td align="left" bgcolor="#888888">
                                                                                                &nbsp;<?= $dbgseh['SIZE_NAME'] ?></td>
                                                                                            <td align="left" bgcolor="#888888">
                                                                                                &nbsp;<?= $dbgseh['UOM_NAME'] ?></td>
                                                                                            <?php if ($_GET['clam'] != 'true'): ?>
                                                                                                <td align="right" bgcolor="#888888">
                                                                                                    &nbsp;<?= $dbgseh['GPL_PRICE'] ?></td>
                                                                                                <td align="right" bgcolor="#888888">
                                                                                                    &nbsp;<?= $dbgseh['STOCK_BALANCE'] ?></td>
                                                                                                <?php
                                                                                            endif;
                                                                                            if ($_GET['bo'] == 'true' || $_GET['clam'] == 'true'):
                                                                                                ?>
                                                                                                <td align="center" bgcolor="#888888"><input type="checkbox"
                                                                                                                                            name="goods_code[]"
                                                                                                                                            value="<?= $dbgseh[0]; ?>"/>
                                                                                                </td>
                                                                                            <?php endif; ?>
                                                                ...
                                                                <input type="hidden" value="<?= $m ?>" name="max">
                                                                    ...
                                                                    <?php if ($_GET['bo'] == 'true' || $_GET['clam'] == 'true'): ?>
                                                                        <input type="reset" class="Xcloase" value="">
                                                                            <input type="button" class="cinfirm" value="" name="bt_submit">
                                                                                <?php
                                                                            endif;
                                                                        endif;
                                                                        ?>
