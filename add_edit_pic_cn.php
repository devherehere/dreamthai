...
<script src="js/jquery-1.7.min.js" type=""></script>
<script src="js/jquery-ui-1.7.2.custom.min.js" type=""></script>
<script src="js/jquery.colorbox.js" type=""></script>
<script type="">
        ...
        <fieldset
		 ...
		 WHERE AR_CN_ID = " . $_SESSION ['id_cn'] . " AND AR_CND_ITEM = " . $_SESSION ['id_item'] . " ORDER BY AR_CNP_ITEM ASC ";
            ...
            <table width="100%" border="0" cellspacing="1"
				...
				<fieldset
					...
					<form method="post"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><input type="file" name="upload" class="uplode" /> หมายเหตุ
						...
						<div class="show_pic"
							style="display: none; border: 1px dashed #000000; width: 200px; height: 150px;">

							<img class="show_pic" width="200" height="150" src=""
				...
				<a href="add_edit_pic_cn.php?id=&lt;?= md5('save') ?&gt;"
					class="savepic"></a> <a
					href="clear_temp.php?id=&lt;?= md5('del_pic_calcle') ?&gt;&amp;item=&lt;?= $_SESSION['id_item'] ?&gt;&amp;itemp=&lt;?= ($i - 1) ?&gt;"
     ...
     VALUES
           ...
           ,'" . $_FILES ["upload"] ["name"] . "')";
			  ...
			  ";
					...
					if ($_GET ['id'] == md5 ( 'save' )) {
						/*
						 * $sql_temp_to_mas = "INSERT INTO [Customer_Return_Picture] SELECT * FROM [Customer_Return_Picture] WHERE [AR_CN_ID] = ".$_SESSION['id_cn']." AND AR_CND_ITEM = ".$_SESSION['id_item'].""; sqlsrv_query($con,$sql_temp_to_mas); sqlsrv_query($con,"DELETE FROM Customer_Return_Picture WHERE AR_CN_ID = ".$_SESSION['id_cn']." AND AR_CND_ITEM = ".$_SESSION['id_item']."");
						 */
