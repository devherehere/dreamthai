...
<body>
<a href="productTemp.php"  class="refesh"  ></a> <a href="clear_temp.php?id=1" class="clear_list"   onclick="return confirm('�س����������')"  ></a> <BR>
<?PHP 
	ob_start();
	@session_start();
...
<table width="100%" border="0" cellspacing="1" cellpadding="0"  style="color:#FFF; font-size:13px;  ">
  ...
  <tr bgcolor="#7f7f7f" height="20">
    ...
    <td align="center"><a href="../clear_temp.php?id=<?=md5('del558')?>&gitem=<?=$reccord['AR_BOD_ITEM']?>"  target="_blank" onClick="return confirm('�س����������')"> <img src="../img/del_list.png"></a></td>
  </tr>
  <?PHP
  $j++;
		  }
