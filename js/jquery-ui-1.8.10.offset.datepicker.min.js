    ...
    d.extend(L.prototype, {markerClassName: "hasDatepicker", log: function() {
        ...
        _connectDatepicker: function(a, b) {
            ...
            var b = this._get(a,
                    "altField");
            if (b) {
                var c = this._get(a, "altFormat") || this._get(a, "dateFormat"), e = this._getDate(a), f = this.formatDate(c, e, this._getFormatConfig(a), this._yearOffset(a));
                d(b).each(function() {
                    d(this).val(f)
                })
            }
        ...
        _ticksTo1970: (718685 + Math.floor(492.5) - Math.floor(19.7) + Math.floor(4.925)) * 24 * 60 * 60 * 1E7, formatDate: function(a, b, c, e) {
            if (!b)
                return "";
            var f = (c ? c.dayNamesShort : null) || this._defaults.dayNamesShort, h = (c ? c.dayNames : null) || this._defaults.dayNames, i = (c ? c.monthNamesShort : null) || this._defaults.monthNamesShort;
            ...
            var e = function(h) {
                ...
                var g =
                        (h.toLowerCase().match(/^c/) ? d.datepicker._getDate(a) : null) || new Date, m = g.getFullYear(), q = g.getMonth();
                g = g.getDate();
        ...
        _generateHTML: function(a) {
            ...
            var u = this._get(a, "dayNamesMin"), x = this._get(a, "monthNames"), A = this._get(a, "monthNamesShort"), v = this._get(a, "beforeShowDay"), p = this._get(a, "showOtherMonths"), w = this._get(a, "selectOtherMonths");
                ...
                for (var M = "", E = 0; E < i[1]; E++) {
                    ...
                    for (var O = 0; O < B; O++) {
                        ...
                        var P = !m ? "" : '<td class="ui-datepicker-week-col">' + this._get(a, "calculateWeek")(s) +
                                "</td>";
                        for (t = 0; t < 7; t++) {
                            var H = v ? v.apply(a.input ? a.input[0] : null, [s]) : [true, ""], C = s.getMonth() != g, K = C && !w || !H[0] || l && s < l || o && s > o;
            ...
            a.yearshtml = "";
            if (h || !q)
                l += '<span class="ui-datepicker-year">' + (c + this._yearOffset(a)+543) + "</span>";
            else {
                ...
                for (a.yearshtml += '<select class="ui-datepicker-year" onchange="DP_jQuery_' +
                    ...
                    a.yearshtml += '<option value="' + b + '"' + (b == c ? ' selected="selected"' : "") + ">" + (b + this._yearOffset(a)+543) + "</option>";
                a.yearshtml += "</select>";
