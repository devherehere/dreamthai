...
$sql_sum_product = "SELECT SUM(TEMP.AR_BOD_TOTAL)AS sumprice , (SUM(TEMP.AR_BOD_TOTAL)*7/100)AS sum_vat FROM (SELECT     Book_Order_Detail.AR_BO_ID, Book_Order_Detail.AR_BOD_ITEM, Book_Order_Detail.GOODS_KEY, Book_Order_Detail.UOM_KEY,
Book_Order_Detail.AR_BOD_GOODS_SELL, Book_Order_Detail.AR_BOD_GOODS_AMOUNT, Book_Order_Detail.AR_BOD_GOODS_SUM,
Book_Order_Detail.AR_BOD_DISCOUNT_PER, Book_Order_Detail.AR_BOD_DISCOUNT_AMOUNT, Book_Order_Detail.AR_BOD_TOTAL,
Book_Order_Detail.AR_BOD_RE_DATE, Book_Order_Detail.AR_BOD_SO_STATUS, Book_Order_Detail.AR_BOD_REMARK,
Book_Order_Detail.AR_BOD_LASTUPD, Units_of_Measurement.UOM_NAME, Goods_Price_List.GPL_PRICE, Goods.GOODS_NAME_MAIN,
Goods.GOODS_CODE
FROM         Book_Order_Detail INNER JOIN
Goods ON Book_Order_Detail.GOODS_KEY = Goods.GOODS_KEY LEFT OUTER JOIN
Goods_Price_List ON Book_Order_Detail.GOODS_KEY = Goods_Price_List.GOODS_KEY LEFT OUTER JOIN
Units_of_Measurement ON Book_Order_Detail.UOM_KEY = Units_of_Measurement.UOM_KEY
